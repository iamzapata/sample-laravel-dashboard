...
{!! Form::open(array('id' => 'create-alert-form', 'class' => "panel")) !!}
    ...
    <div class="row well">
        ...
        <div class="col-xs-6">
            ...
            <div class="form-group">
                {{ Form::label('latin_name', 'Alert Latin Name') }}
                {{ Form::text('latin_name', null, array('class'=>'form-control')) }}
                <span class="validation-error"></span>
            </div>
            <div class="form-group">
                {{ Form::label('alert_searchable_names', 'Other Searchable Names') }}
                ...
                <script>
                    var searchableNames = $('#searchableNames').magicSuggest({
                        ...
                        valueField: 'id',
                        displayField: 'name',
                        placeholder: 'Search for alert related names'
                    });
                </script>
            </div>
